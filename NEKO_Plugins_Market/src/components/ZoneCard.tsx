...
export function ZoneCard({ zone }: ZoneCardProps) {
  ...
  return (
    <Link
      ...
      className="group block p-6 bg-[#1A1A2E] border border-slate-800/50 rounded-xl hover:border-primary/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_30px_oklch(var(--primary)/0.15)]"
    >
      <div
