...
export function PluginCard({ plugin }: PluginCardProps) {
  ...
  return (
    <Link
      to={`/plugin/${plugin.id}`}
      className="group block bg-[#1A1A2E] border border-slate-800/50 rounded-xl p-5 hover:border-primary/30 hover:shadow-[0_0_20px_oklch(var(--primary)/0.15)] transition-all duration-300 hover:-translate-y-1"
    >
      {/* Header */}
